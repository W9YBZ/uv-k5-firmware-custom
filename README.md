...
* KMC-25 PF 菜单项：`MPF1S/MPF1L/MPF2S/MPF2L`（默认：PF1短=宽窄带，PF1长=A/B，PF2短=手电，PF2长=背光）
...
| **短按`侧键2`**                | 设置宽窄带                                                |
| **长按`侧键2`**                | 手电筒                                                  |
| **KMC-25 PF1/PF2**             | 可在菜单 `MPF1S/MPF1L/MPF2S/MPF2L` 中设置                      |
...
| 0x01FE8~0x01FEF                        | KMC-25 手咪 PF1/PF2 按键功能设置                               |
| 0x01FFD~0x01FFE                        | **MDC1200**-MDC ID                                        |
